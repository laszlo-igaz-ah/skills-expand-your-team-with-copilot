document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      const activityDifficulty = (details.difficulty_level || "").toLowerCase();

      // "All" difficulty option should only show activities without specified difficulty
    ...
    activityCard.innerHTML = `
      ...
      ${
        details.difficulty_level
          ? `<p><strong>Level:</strong> ${details.difficulty_level}</p>`
          : ""
      }
      <p class="tooltip">
